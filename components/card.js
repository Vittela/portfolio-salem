    ...
    <div class="content">
        <div class="back">
            <div class="back-content">
                <slot name="icon">
                <!-- Fallback padrão se nenhum ícone for passado -->
...
<style>
    ...
    .back::before {
        ...
        width: 160px;
        height: 160%;
        background: linear-gradient(90deg, transparent, #ff7ce3ff, #ff7ce3ff, #ff7ce3ff, #ff7ce3ff, transparent);
...
customElements.define("one-card", card)
